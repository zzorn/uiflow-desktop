...
import org.uiflow.desktop.gradient.ColorGradient;
import org.uiflow.desktop.gradient.ColorGradients;
import org.uiflow.desktop.ui.SimpleFrame;
import org.uiflow.desktop.utils.ColorValueConverter;
...
public class ChartExample {
    ...
    public static void main(String[] args) {
        ...
        DataSeries<Long, Integer> numberOfPiratesOverTime = new ArrayListDataSeries<Long, Integer>(time, startTime, 20*oneYear,
                                                                                                   30,
                                                                                                   65,
                                                                                                   123,
                                                                                                   150,
        ...
        // TODO: Create static utility methods that make it easier to do this kind of initialization without typing in all the types by hand.
        // TODO: Also create shortcuts to create converters to color or range.  Maybe as methods on the data series?  Or at least as some statical utility functions, or maybe as methods in a visualization channel?
        pirateChart.barColor.setData(new DataSeriesConverter<Long, Integer, Color>(numberOfPiratesOverTime, new ColorValueConverter<Integer>(ColorGradients.SPECTRUM, 0, 1.0/500, 0)));
